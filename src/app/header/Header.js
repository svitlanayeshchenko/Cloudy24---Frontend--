                ...
                <div className="header">
                    ...
                    <div className="header-navigation">
                        <ul className={appModalBurgerStore.getState().modalBurgerMenuVisible ? ["navigation", "active"].join(" ") : ["navigation"]} onClick={this.clickHandler}>
                            ...
                            <li className="navigation-item"><NavLink to={`${process.env.REACT_APP_PUBLIC_URL}/promo_international-transfers`}>Міжнародні перекази</NavLink></li>
                            <li className="navigation-item"><NavLink to={`${process.env.REACT_APP_PUBLIC_URL}/promo_bonds`}>Облігації</NavLink></li>
                            <li className="navigation-item"><NavLink to={`${process.env.REACT_APP_PUBLIC_URL}/promo_ind-entrepreneur`}>ФОП</NavLink></li>
                        </ul>
                        <UserPageButton />
